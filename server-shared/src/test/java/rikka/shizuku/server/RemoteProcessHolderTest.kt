...
/** The process handle handed to a client by `newProcess`. */
@RunWith(RobolectricTestRunner::class)
@Config(sdk = [34], manifest = Config.NONE)
class RemoteProcessHolderTest {
    ...
    fun aliveIsExitValueInverted() {
        ...
        val holder = RemoteProcessHolder(process, null)
    ...
    fun ownerDeathDestroysALiveProcess() {
        ...
        RemoteProcessHolder(process, owner)
