 ...
 * Porter's permission, one declares Shizuku's or Shizuku+'s, the `shizuku-compat` artifact below
 * is on the classpath, and this provider holds the authority. Without either of the last two the
 * answer stays [PorterAvailability.NotInstalled].
